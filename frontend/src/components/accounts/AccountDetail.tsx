    ...
    <Box>
        ...
        <>
          ...
          <Collapse in={passwordOpen}>
            <Stack spacing={1} sx={{ mt: 1 }}>
              ...
              >
                {savingPassword ? <CircularProgress size={18} color="inherit" /> : '保存密码'}
              </Button>
            </Stack>
          </Collapse>
        </>
      ...
      {!account.enabled && (
        <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mt: 2 }}>
          ...
          <Button variant="contained" onClick={handleEnable} disabled={enabling}>
            {enabling ? <CircularProgress size={18} color="inherit" /> : '启用'}
          </Button>
        </Stack>
      )}
